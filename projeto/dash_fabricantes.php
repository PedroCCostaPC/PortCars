<?php 
    ...
    // PEGANDO TABELA DE FABRICANTE E 
...
<style>
    #menu-dash nav ul li:nth-child(2) a {
...
<div class="dash-container container">
    ...
    <div id="publicacoes">
        ...
        <div class="filtro">
            ...
            <div class="opcoes">
                <a href="<?= $BASE_URL ?>dash_fabricantes.php?filtro=todos">Todos (<?= count($allPosts) ?>)</a>

                <!-- PUBLICADOS -->
                <a href="<?= $BASE_URL ?>dash_fabricantes.php?filtro=publicados">
                    Publicados 
                ...
                <!-- RASCUNHOS -->
                <a href="<?= $BASE_URL ?>dash_fabricantes.php?filtro=rascunho">
                    Rascunhos 
                ...
                <!-- AUTOR DO POST -->
                <a href="<?= $BASE_URL ?>dash_fabricantes.php?filtro=meus">
                    Minhas publicações 
                ...
                <!-- MAIS ANTIGOS -->
                <a href="<?= $BASE_URL ?>dash_fabricantes.php?filtro=antigos">
                    Mais antigos
                </a>

                <!-- MAIS NOVOS -->
                <a href="<?= $BASE_URL ?>dash_fabricantes.php?filtro=novos">
                    Mais novos
                </a>
            </div>
        </div><!-- Fim div filtro -->
